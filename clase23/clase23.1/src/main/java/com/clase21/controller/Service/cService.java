package com.clase21.controller.Service;
...
import com.clase21.controller.Repository.cRepository;
...
public class cService {
	...
	public List<Client> getByNameQuery(String name) {
		return CRepo.searchClient(name);
	}
	//GET ALL CLIENTS
